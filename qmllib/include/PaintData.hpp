...
Q_OBJECT
public:
    Q_INVOKABLE PaintObject(QObject* parent = nullptr);
    Q_INVOKABLE ~PaintObject();
...
Q_OBJECT
public:
    Q_INVOKABLE PaintRect(QObject* parent = nullptr);
    Q_INVOKABLE ~PaintRect();
...
class IMAGETOOLQML_EXPORT PaintCrossLine : public PaintObject
{
Q_OBJECT
public:
    Q_INVOKABLE PaintCrossLine(QObject* parent = nullptr);
    Q_INVOKABLE ~PaintCrossLine();
    PaintCrossLine(const PaintCrossLine & other);
    Q_PROPERTY(QVariant x READ getX WRITE setX)
    Q_PROPERTY(QVariant y READ getX WRITE setY)
    Q_PROPERTY(QVariant width READ getX WRITE setWidth)
    Q_PROPERTY(QVariant length READ getLength WRITE setLength)
    Q_PROPERTY(QVariant center READ getCenter WRITE setCenter)
    virtual void paint(QPainter* painter, const QRectF& imgRect, const QSizeF& itemSize) override;
    virtual void paintImage(cv::Mat* paintImg) override;
public slots:
    QVariant getX() const;
    QVariant getY() const;
    void setX(QVariant var);
    ...
    QVariant getWidth() const;
    void setWidth(QVariant var);
    QVariant getLength() const;
    void setLength(QVariant var);
    QVariant getCenter() const;
    void setCenter(QVariant var);
private:
    double x;
    double y;
    int width;
    int length;
};Q_DECLARE_METATYPE(PaintCrossLine);

class IMAGETOOLQML_EXPORT PaintPath : public PaintObject
{
Q_OBJECT
public:
    Q_INVOKABLE PaintPath(QObject* parent = nullptr);
    Q_INVOKABLE ~PaintPath();
...
Q_OBJECT
public:
    Q_INVOKABLE PaintText(QObject* parent = nullptr);
    Q_INVOKABLE ~PaintText();
...
Q_OBJECT
public:
    Q_INVOKABLE ImageToolPaintData(QObject* parent = nullptr);
    Q_INVOKABLE ~ImageToolPaintData();
